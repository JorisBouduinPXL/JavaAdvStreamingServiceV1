...
import be.pxl.ja.streamingservice.account.CreditCardNumber;
import be.pxl.ja.streamingservice.account.CreditCardType;
import be.pxl.ja.streamingservice.account.PaymentInfo;
...
public class RegistrationController implements Initializable {
    ...
    public void onContinue(ActionEvent actionEvent) throws DuplicateEmailException {
        try {
